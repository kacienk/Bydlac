...
1. [React crash course 4h](https://www.youtube.com/watch?v=Dorf8i6lCuk)
2. [Simple react project in 30 min](https://www.youtube.com/watch?v=hQAHSlTtcmY)
3. [Intro to React](https://reactjs.org/tutorial/tutorial.html)
...
2. [Python Chat Tutorial with Django and React](https://getstream.io/blog/tutorial-build-chat-with-python/)
3. [Build a Chat App with Django Channels](https://justdjango.com/blog/chat-app-django-channels)
